  ...
  <v-app id="inspire" dark style="background-color:#263238">
    <v-toolbar app style="background-color:#37474F">
      ...
      <v-card-text class=" text-sm-left headline">
        ...
        <router-link to="/" class="sadrCryptoText">SadrCrypto<span class="body-2">.com</span></router-link><router-link class="" to="/"><v-icon color="amber darken-2">group_work</v-icon></router-link>
