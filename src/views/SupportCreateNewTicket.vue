                    ...
                    <div>
                        <v-card>
                            <c-card-text>
                                ...
                                <span>کاربران عزیز، به مقدار غیرمعمول بلیط فعلی زمان پاسخ فعلی ما 2 روز است. با مهربانی از شما می خواهیم که بلیط های چندگانه را در رابطه با همین مسئله باز نکنید، زیرا شما فقط زمان پاسخ طولانی خود را می گیرید.</span>
                            </c-card-text>
                        </v-card>
                    </div>
                    <div>
                        <v-card>
                            <v-card-text>
                                <span>لطفا یک لحظه از وقت خود را برای توضیح مسئله خود بکشید. هیچ یک از گزینه های زیر مطابق موضوع شما نیست. لطفا دیگران را انتخاب کنید و موضوع خود را در نوشتن زمان پاسخ ما شرح دهید.</span>
                            </v-card-text>
                        </v-card>
                    </div>
                    <div>
