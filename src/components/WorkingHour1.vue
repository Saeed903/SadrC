...
<div>
    <v-layout>
        <v-flex xs3 sm1 md1 lg1>
            <v-card-text class="fontIran">شنبه</v-card-text>
        </v-flex>
        <v-flex xs5 sm4 md3 lg3>
            <v-text-field type="number" class="fontIran" label="از ساعت" color="cyan accent-2"></v-text-field>
        </v-flex>
        <v-flex xs5 sm4 md3 lg3>           
            <v-text-field type="number" class="fontIran" label="تا ساعت" color="cyan accent-2"></v-text-field>
        </v-flex> 
    </v-layout>
